...
```
According to the latter results, the model clasified `r ((3157+2109+1895+1788+2098)/11776)*100` observations correctly in training set. A gradient boosted model with multinomial loss function.
...
```
The algorithm correctly classified `r (7215/7846)*100` observations on the testing set, performing a little worse than the training set.
...
## Conclusion
As showed by the automatic correction of the assignment in the course site, a total of 20/20 right predictions for the type of activity was obtained, indicating that the algorithm's performance is very accurate.
